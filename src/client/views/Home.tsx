        ...
        <Layout>
            <div className="bg-custom-service-card-bg text-light pb-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 ml-3 border border-left-0 border-bottom-0 border-top-0">
                        <p className="lead">Ongoing donation drive providing brand new pairs of socks to thousands of New Yorkers living on the streets & in shelters.</p>
                        <p className="font-weight-lighter">We are here to collect socks and inspire others to see a need in their community and be creative in their approaches to fill that need.</p>
